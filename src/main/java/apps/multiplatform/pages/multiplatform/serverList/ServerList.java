package apps.multiplatform.pages.multiplatform.serverList;

import apps.common.FingerMove;
import apps.multiplatform.pages.BasePage;
import apps.multiplatform.pages.multiplatform.connection.ConnectionDetail;
...
public class ServerList extends BasePage {
    ...
    public WebElement findServer(apps.multiplatform.api.Server server) {
    ...
    private WebElement scrollDown(apps.multiplatform.api.Server server) {
        new FingerMove(appiumDriver).doSwipe(0.5, 0.8, 0.5, 0.66);
    ...
    @Step("select server")
    public ConnectionDetail selectServer(apps.multiplatform.api.Server server) {
